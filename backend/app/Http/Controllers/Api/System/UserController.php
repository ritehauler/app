...
class UserController extends Controller
{
    ...
    private $_object_identifier = "users";
    private $_entity_identifier = "users"; // usually routes path
    private $_entity_pk = "user_id";
    private $_entity_ucfirst = "User";
    private $_entity_model = "User";
    ...
    public function post(Request $request)
    {
        ...
        // validations
        $rules = array(
            'target_entity_id' => 'required|integer:exists:' . $exModel->table . "," . $exModel->primaryKey . ",deleted_at,NULL",
            'title' => "required|string|unique:".$this->_entity_model->table.",".$this->_entity_model->primaryKey.",NULL,deleted_at,parent_id,".$request->parent_id,
            //'slug' => "required|string|unique:".$this->_entity_model->table.",".$this->_entity_model->primaryKey.",NULL,deleted_at,parent_id,".$request->parent_id,
            'description' => 'string',
            'created_by' => 'required|integer:exists:' . $exModel->table . "," . $exModel->primaryKey . ",deleted_at,NULL",
        );
    ...
    public function listing(Request $request)
    {
        ...
        $exModel = new $exModel;
        // allowed order
        $allowed_ordering = $allowed_searching = $this->_entity_model->primaryKey . ",title,slug,description,created_by,created_at";
        ...
        $rules = array(
            ...
            'target_entity_id' => 'integer:exists:' . $exModel->table . "," . $exModel->primaryKey . ",deleted_at,NULL",
            'title' => 'string',
