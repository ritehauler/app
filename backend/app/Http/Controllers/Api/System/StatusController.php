...
class StatusController extends Controller
{
    ...
    private $_object_identifier = "status";
    private $_entity_identifier = "system_status"; // usually routes path
    private $_entity_pk = "status_id";
    private $_entity_ucfirst = "Status";
    private $_entity_model = "SYSStatus";
    ...
    {
        // fix indexes
        $fix_indexes = array($this->_entity_pk, "entity_id", "sequence");
        // search
