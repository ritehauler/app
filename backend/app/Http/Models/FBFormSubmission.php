...
class FBFormSubmission extends Base {
	
	use SoftDeletes;
    public $table = 'fb_form_submission';
	...
	public function __construct()
	{
        ...
        // set fields
        $this->__fields   = array($this->primaryKey, 'user_form_id', 'field_id', 'submission', 'created_at', 'updated_at', 'deleted_at');
	}
