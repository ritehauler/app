<?php
namespace App\Http\Controllers\Api\Extension\Review;
...
class IndexController extends Controller
{
    ...
    private $_pModel = "ExtReview"; // extension model
    private $_pHook = "ExtReview"; // extension hook
    ...
    public function post(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $this->_apiData['message'] = trans($this->_extIdentifier . '.already_reviewed', array("entity" => $entity_type->identifier));
        } else {
            // success response
