<?php
namespace App\Http\Controllers\Api\Extension\Favorite;
...
class IndexController extends Controller
{
    ...
    private $_pModel = "ExtFavorite"; // extension model
    private $_pHook = "ExtFavorite"; // extension hook
    ...
    public function post(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $this->_apiData['message'] = trans($this->_extIdentifier . '.already_marked', array("entity" => $entity_type->identifier));
        } elseif ($request->switch == 0 && $id == 0) {
            $this->_apiData['message'] = trans($this->_extIdentifier . '.have_not_marked', array("entity" => $entity_type->identifier));
        } else {
            // success response
            ...
            if ($id > 0) {
                ...
                // api msg
                $this->_apiData['message'] = trans($this->_extIdentifier . '.entity_remove_success', array("entity" => $entity_type->identifier));
                ...
                // api msg
                $this->_apiData['message'] = trans($this->_extIdentifier . '.entity_mark_success', array("entity" => $entity_type->identifier));
            }
