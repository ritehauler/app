<?php
namespace App\Http\Controllers\Api\Extension\Social\Reply;
...
class IndexController extends Controller
{
    ...
    private $_pModel = "ExtSocialReply"; // extension model
    private $_pHook = "ExtSocialReply"; // extension hook
    ...
    public function post(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), array(
            ...
            // reply
            'reply' => 'required_without:json_data',
            // json data
            "json_data" => "required_without:reply|json",
