<?php
namespace App\Http\Controllers\Api\Extension\Social\Like;
...
class IndexController extends Controller
{
    ...
    private $_pModel = "ExtSocialLike"; // extension model
    private $_pHook = "ExtSocialLike"; // extension hook
    ...
    public function post(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($id > 0) {
                ...
                // api msg
                $this->_apiData['message'] = trans($this->_extIdentifier . '.entity_unlike_success', array("entity" => $entity_type->identifier));
                ...
                // api msg
                $this->_apiData['message'] = trans($this->_extIdentifier . '.entity_like_success', array("entity" => $entity_type->identifier));
            }
