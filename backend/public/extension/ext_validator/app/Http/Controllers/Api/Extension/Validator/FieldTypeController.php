...
class FieldTypeController extends Controller
{
    ...
    private $_activityIdentifier = "field_type";
    //private $_activityTypeModel = "ExtActivityType"; // extension required model
    private $_pModel = "FieldType"; // extension model
    private $_pHook = "FieldType"; // extension hook
     ...
     * @return Response
     */
    public function xpost(Request $request)
    {
        // trim/escape all
