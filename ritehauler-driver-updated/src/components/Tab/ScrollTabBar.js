...
const ScrollTabBar = createClass({
  propTypes: {
  ...
  renderTab(name, page, isTabActive, onPressHandler, onLayoutHandler) {
    ...
    */
    const textColor = isTabActive ? activeTextColor : inactiveTextColor;
    const fontFamily = isTabActive ? Fonts.type.base : Fonts.type.light;
    ...
    return (
      ...
      >
        <View style={[styles.tab, this.props.tabStyle]}>
          <Text style={[{ color: textColor, fontFamily }, styles.tabBarText]}>
            {name}
          </Text>
        </View>
      </Button>
