...
import { ServerRequestPage, BottomButton } from "../../components";
...
import { ENTITY_TYPE_ID_ITEM } from "../../constant";
...
class SearchItemName extends Component {
  static propTypes = {
    cbOnItemNameSelected: PropTypes.func.isRequired,
  ...
  onPressButton() {
    if (this.itemName || this.otherItemText !== "") {
      this.props.cbOnItemNameSelected(this.itemName, this.otherItemText);
      Actions.pop();
    } else {
      Utils.showMessage(Strings.errorMessageItemName);
    }
  }
...
export default connect(mapStateToProps, actions)(SearchItemName);
