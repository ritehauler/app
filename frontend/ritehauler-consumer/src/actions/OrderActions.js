...
export function saveVehicleOrder(vehicle: Object, orderInfo: Object) {
  return {
    vehicle,
    orderInfo,
    type: SAVE_VEHICLE_ORDER
  };
}

export function saveDeliveryProfessionalOrder(
  deliveryProfessional: Object,
  orderInfo: Object
) {
  return {
    deliveryProfessional,
    orderInfo,
    type: SAVE_DELIVERY_PROFESSIONAL_ORDER
  };
}
